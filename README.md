...
<tr><td>text<td>byte<td>Текст в кодировке win-1251, если поле <b>len</b> равно 0, то поля <b>text</b> отсутствует
</table>
<h3>time</h3>
...
<table><tr><th>Имя поля<th>тип<th>описание
<tr><td>signature<td>dword<td>Должно содержать текст "SDB ", если это не так - поле отсутствует. После этого поля располагается массив пар <b>id</b> - <b>value</b>.
...
В файлах с расширением <b>itm</b> хранятся итформация о предмете инвентаря. Имя файла - это идентификатор предмета (<b>itemId</b>). 
<table><tr><th>Имя поля<th>тип<th>описание
